...
int main() {
	...
	const std::string streamFileName = "G:/StreamsDissertation/RealesSetup/Geometrie/All_Spectrum_Zylinder1_PMMA_Sweep" + std::to_string(sweep) + "ns_" + std::to_string(SourcePower) + "uCi.drs4DataStream";


	fstream myfile("G:/StreamsDissertation/RealesSetup/Geometrie/All_Spectrum_Zylinder1_PMMA_AnalyseParameter" + std::to_string(SourcePower) + "uCi.txt", ios::out);
