...
int main() {
	...
	const std::string streamFileName = "G:/StreamsDissertation/RealesSetup/Geometrie/Background_aKegel2_Sweep" + std::to_string(sweep) + "ns_" + std::to_string(SourcePower) + "uCi.drs4DataStream";


	fstream myfile("G:/StreamsDissertation/RealesSetup/Geometrie/Background_aKegel2_AnalyseParameter" + std::to_string(SourcePower) + "uCi.txt", ios::out);


	//Input Streams

	ifstream ifile("C:/Users/Simulationsrechner/Desktop/Geant4MeetsPulsGenerator/Streams/1275keV_aKegel2_Al_probe_1.5mm_Abstand_3mm.stream", ios::binary);
	ifstream ifile511("C:/Users/Simulationsrechner/Desktop/Geant4MeetsPulsGenerator/Streams/511keV_aKegel2_Al_probe_1.5mm_Abstand_3mm.stream", ios::binary);
