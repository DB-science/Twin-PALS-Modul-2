...
double positronAnhillationLifetime(double lifetime1, double lifetime2, double lifetime3, double lifetime4, double lifetime5, double intensity1,
    ...
    std::exponential_distribution<double>& distribution2, std::exponential_distribution<double>& distribution3, std::exponential_distribution<double>& distribution4, std::exponential_distribution<double>& distribution5,
