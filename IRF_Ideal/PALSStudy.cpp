...
int main() {
	...
	const std::string streamFileName = "G:/StreamsDissertation/RealesSetup/Geometrie/IdealesIRF_Zylinder1_PMMA_Sweep" + std::to_string(sweep) + "ns_" + std::to_string(SourcePower) + "uCi.drs4DataStream";


	fstream myfile("G:/StreamsDissertation/RealesSetup/Geometrie/IdealesIRF_Zylinder1_PMMA_AnalyseParameter" + std::to_string(SourcePower) + "uCi.txt", ios::out);
	...
	//positron lifetime!
	int NumberOfComponentes = 1; //the number of Components the Positron lifetime Spectrum should have. 1 to 5 Components availible, Intensity must add to 1.
	double lifetime1 = 0.0;double intensity1 = 1.0;
	double lifetime2 = 0.0;double intensity2 = 0.172;
	double lifetime3 = 0.0;double intensity3 = 0.003;
