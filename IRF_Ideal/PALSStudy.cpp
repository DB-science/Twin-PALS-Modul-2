	...
	for (int i = 0; i < 50; i++) {
		...
		if (ifile.is_open() || ifile511.is_open())
		{
			...
			while (!ifile.eof()) {
				...
				double PALS = 0.0;// positronAnhillationLifetime(lifetime1, lifetime2, lifetime3, intensity1, intensity2, intensity3, distribution1, distribution2, distribution3, generator);
